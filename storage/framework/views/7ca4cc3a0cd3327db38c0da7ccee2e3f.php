                        ...
                        <div class="">
                            ...
                            <select id="docTypes_select" class="form-control opt-p" name=""
                                ...
                                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option data-total-page="<?php echo e($document['no-of-pages']); ?>"
                                        value='<?php echo e($document['DocName']); ?>'><?php echo e($document['DocName']); ?></option>
                    ...
                    <div class="uploaded_list_cont">
                        ...
                        <div class="uploaded_select_box">
                            ...
                            <select id="uploaded_list_select" class="form-control opt-p" name=""
                                ...
                                <?php $__currentLoopData = $uploaded_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc_files): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value='<?php echo e($doc_files['files']); ?>'><?php echo e($doc_files['file_name']); ?>
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/tiff_image-min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/js/canvas-zoom.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/js/simplePagination.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/js/chatbot.js')); ?>"></script>
<script>
    ...
    function get_image(file_name, page_no, data_type = 'sample', ajax_call = true, build_file_name = true) {
        ...
        if (ajax_call == true) {
            //ajax
            $.post("<?php echo e(url('/get_image')); ?>", data, function(data, status) {
                if (data == "force_redirect") {
                    location.reload()
                }
    ...
    function get_documents(thisData, data_type = 'sample') {
        ...
        if (thisData.attr('data-click') == '1') {
            //ajax
            $.post("<?php echo e(url('/')); ?>/" + url, data, function(data, status) {
    ...
    $(function() {
        ...
        <?php if(isset($_GET['file'])): ?>
            $('#preloader').show()
            // check_document_status('<?php echo e($_GET['file']); ?>')
            $('#uploaded_list_select').val('<?php echo e($_GET['file']); ?>').trigger('change');
        ...
        <?php if(isset($_GET['sample_file'])): ?>
            $('#preloader').show()
            let value = '<?php echo e($_GET['sample_file']); ?>'
