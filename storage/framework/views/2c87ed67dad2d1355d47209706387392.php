                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <form method="POST" class="form-horizontal" action="<?php echo e(url('register')); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('name')); ?>" id="name" name="username" autofocus required
