	...
	var methods = {
		...
		_draw: function() {
			...
			if (interval.start > 0 && o.edges > 0) {
				...
				if (o.edges < interval.start && o.ellipseText) {
					$panel.append('<li><a class="ellipse"><span>' + o.ellipseText + '</span></a></li>');
				}
			}
		...
		_appendItem: function(pageIndex, opts) {
			...
			if (pageIndex == o.currentPage || o.disabled) {
				$link = $('<li><a class="active"><span>' + (options.text) + '</span></a></li>');
			} else {
				$link = $('<li><a data-toggle="tab" href="' + o.hrefText + (pageIndex + 1) + '" class="page-link">' + (options.text) + '</a></li>');
				$link.click(function(){
